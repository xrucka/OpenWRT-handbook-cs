...
XWAY \todo{doplň SOC}.} podporujícím jak \gls{adsl} 2+,
...
\item[tone] \todo{rozepiš tón}. Mezi možné \todo{tóniny} patří \uv{a}, \uv{v}, \uv{x}; přičemž
k \todo{tóninám} \uv{a} a \uv{b} lze připojit znak \uv{v}, značící vektorizaci.
